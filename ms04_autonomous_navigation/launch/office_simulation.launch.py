...
def generate_launch_description():
    ...
    world_file = os.path.join(pkg_ms04, 'worlds', 'office.world')
    ...
    declare_x = DeclareLaunchArgument('x_pose', default_value='0.0', description='Initial X position in office')
    declare_y = DeclareLaunchArgument('y_pose', default_value='0.0', description='Initial Y position in office')
